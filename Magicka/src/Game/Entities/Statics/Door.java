...
public class Door extends StaticEntity {
    ...
    public Door(Handler handler, float x, float y,BaseWorld world, Chest ch) {
    ...
    private void checkForPlayer(Graphics g, Player p) {
        ...
        if(ir.contains(pr) && !EP){
            ...
            g.drawImage(Images.EP,(int)(x-handler.getGameCamera().getxOffset()),(int)(y-handler.getGameCamera().getyOffset()),32,32,null);
