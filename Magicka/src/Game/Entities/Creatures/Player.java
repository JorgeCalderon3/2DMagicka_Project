...
public class Player extends CreatureBase {
    ...
    public void render(Graphics g) {
        ...
        if(this.getHealth()>50){
            ...
            g.fillRect((int)(x-handler.getGameCamera().getxOffset()),(int)(y-handler.getGameCamera().getyOffset()-20),75,10);
        	...
        	g.drawString("LOOK FOR WOODS TO GET HEALTH", (int)(x-handler.getGameCamera().getxOffset()-1),(int)(y-handler.getGameCamera().getyOffset()-50));
    ...
    public void die(){
        ...
        State.setState(handler.getGame().diedState);
    }
    ...
    private void getInput(){
        ...
        if(handler.getKeyManager().right&&! attacking)
            xMove = speed;
        if(handler.getKeyManager().healthPlayer)
        	health++;
        if(handler.getKeyManager().nextWorld) {
        	BaseWorld world1 = new World1(handler,"res/Maps/map1.map",this );
        	BaseWorld world2 = new World2(handler,"res/Maps/map2.map",this );
			BaseWorld caveWorld = new CaveWorld(handler,"res/Maps/caveMap.map",this);
        	switch(flag) {
	        	case 0:
