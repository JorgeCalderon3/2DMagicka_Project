...
public class Images {
    ...
    public static BufferedImage chestC;
    public static BufferedImage chestO;
  
    public static BufferedImage E;
    public static BufferedImage skelly;
    ...
    public static BufferedImage[] OptionsQuit;
    ...
    public Images() {
        ...
        BossEnemy_left = new BufferedImage[1];
        BossEnemy_right = new BufferedImage[1];
        BossEnemy_front = new BufferedImage[1];
        BossEnemy_back = new BufferedImage[1];
        ...
        try {
            ...
            GameWon = ImageIO.read(getClass().getResourceAsStream("/Buttons/victory-royal.jpg"));
            Instructions = ImageIO.read(getClass().getResourceAsStream("/Buttons/instructions.png"));
            GoBack = ImageIO.read(getClass().getResourceAsStream("/Buttons/go-back.png"));
            ...
            items[3] = ImageIO.read(getClass().getResourceAsStream("/Sheets/stick.png"));
            skelly=ImageIO.read(getClass().getResourceAsStream("/Sheets/axe.png"));
            chestC = chestSheet.crop(0, 0, 32, 32);
            chestO = chestSheet.crop(32, 0, 32, 30);
            ...
            BossEnemy_front[0]=ImageIO.read(getClass().getResourceAsStream("/Sheets/EnemyFront.png"));
            BossEnemy_back[0]=ImageIO.read(getClass().getResourceAsStream("/Sheets/EnemyBack.png"));
            BossEnemy_left[0]=ImageIO.read(getClass().getResourceAsStream("/Sheets/EnemyLeft.png"));
            BossEnemy_right[0]=ImageIO.read(getClass().getResourceAsStream("/Sheets/EnemyRight.png"));
